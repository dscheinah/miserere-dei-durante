...
%}
    \new Voice = "A" \relative sol' {
      ...
      r8 sib sib si  do2 (fa,4) sib8 sib sib4 la sib r r2 r1 r8 do do do do4 sib lab la8 la re, [mib16 fa] sol4 sol8 sol sol sol lab4 sol fa8 [lab] sol4 fa sol lab la8 la sol2 sol4 r r2 \section
      ...
      r4 re, (mib) fad sol sol2 fad4 r la2 sol4 (sol) fad sol r r8 sol sol sol do4 si! do sol r2 sol sol sol4 r r2 sol2 sol
       sol8 sol sol sol sol4 fa fa mib re re do1 \section \tempo "Largo"  la'4.^"[Solo]" la8 sold sold la si la4 sold la2 sold8 mi fad sold! la2 sold4 sold8^"[Tutti]" la si4 la sold sold r sold!8 la si4 la sold la (la) sold la r
      ...
      r4 fa8 fa fa8. fa16 fa4 sib8 sib r4 r2 r1 r1 sib4 sib8 sib la4 sib sib? la sib r r1 r1 r2 sib4 sib8 sib la [fa] fa4 fa2 fa fa4 r \fermata \section
      ...
      sib?4 r r8 si si do16[ re] do4 r r8  mi, mi fa16[ sol] fa8 fa r4 r8 mi mi fa16[ sol] fa8 la re, sib' la2 la4 r r8 la la la la la r4 r8 la la la la la fa sib la2 la4 r r2 \section \tempo "Andante"  r1 r1
      r1 r r r r r r2 r8 sol sol sol fad fad r4 r8 fad fad fad sol sol r4 r8 sol sol sol sol sol r4 r sib
      la4 r r la sib8 fa fa fa sib2 sol4. la16[ sol] fad8 re sol4 (sol) fad sol r r8 sib sib sib la la r4 r la sol r r8 sol sol sol sol2 fad8[ re] sol2 fad4 sol r r2 r1 \section
