...
\score {
  \new Staff { % Crée une seconde portée
    ...
    \new Voice = "B" \relative do' {
      ...
      mib4 mib r8 do' do sib la4 sib8 sib fa2 sib,4 r4 r2 r8 lab' lab sol fa4 mi! fa sol lab sol fa fad8 fad sol2 do,8 do' do sib lab4  mi! fa sol lab sol fa fad8 fad sol2 do,4 r r2 \section
      ...
      do,4 r r2 si!4 do sol'4. sol8 do,1 \section r r r r4 mi8^"[Tutti]" fad sold4 la mi mi r mi8 fad sold4 la mi8 re do re mi2 la,4 r
      ...
      r4 sib8 sib la!8. la16 la4 sib8 sib r4 r2 r1 r sib8 [sib,] reb mib fa4 sib fa2 sib,4 r r1 r r2 sib'8 [sib,] reb mib fa2 sib fa sib,4 r \fermata \section
      \tempo "Largo"
      r2 r8 sol' sib sol re'4 r r8 re,8 fad re sol4 r r8 sol si! sol do4 r r8 fa,8 sol[ sol,] 
      do4 r r8 fa la fa sib4 r r8  mib, fa[ fa,] sib4 r r2 r1 r2 r8 fa' la fa sib4 r r8 sol si sol do4 r r8 la dod la re re r4 r8 la dod la re la sib sol la4 la, re r r8 la' dod la re re r4 r8 la dod la re la sib sol la4 la, re r r2 \section \tempo "Andante"  r1 r
      r1 r r r r r r2 r8 sol sol sol re re r4 r8 re re re sol sol r4 r8 sol sol sol do do r4 r do fa, r r fa sib, r r8 sib! sib sib mib2 re8 [fad sol do,] re2 sol,4 r r8 sol' sol sol re re r4 r re sol r r8 sol sol fa! mib2 re8 [ fad sol do,] re2 sol,4 r r2 r1 \section
